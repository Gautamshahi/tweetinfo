This GitHub repository corresponds dataset used for TweetInfo. The dataset is shared by following the Twitter data sharing policy. The description of the columns are given below
